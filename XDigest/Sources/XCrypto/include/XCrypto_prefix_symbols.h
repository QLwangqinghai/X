...
#define XCRYPTO_ARMcap_P BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, XCRYPTO_ARMcap_P)
...
#define sk_ASN1_STRING_TABLE_call_free_func BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sk_ASN1_STRING_TABLE_call_free_func)
#define sk_ASN1_STRING_TABLE_call_copy_func BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sk_ASN1_STRING_TABLE_call_copy_func)
#define sk_ASN1_STRING_TABLE_call_cmp_func BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sk_ASN1_STRING_TABLE_call_cmp_func)
#define sk_ASN1_STRING_TABLE_new BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sk_ASN1_STRING_TABLE_new)
#define sk_ASN1_STRING_TABLE_new_null BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sk_ASN1_STRING_TABLE_new_null)
#define sk_ASN1_STRING_TABLE_num BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sk_ASN1_STRING_TABLE_num)
#define sk_ASN1_STRING_TABLE_zero BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sk_ASN1_STRING_TABLE_zero)
#define sk_ASN1_STRING_TABLE_value BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sk_ASN1_STRING_TABLE_value)
#define sk_ASN1_STRING_TABLE_set BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sk_ASN1_STRING_TABLE_set)
#define sk_ASN1_STRING_TABLE_free BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sk_ASN1_STRING_TABLE_free)
#define sk_ASN1_STRING_TABLE_pop_free BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sk_ASN1_STRING_TABLE_pop_free)
#define sk_ASN1_STRING_TABLE_insert BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sk_ASN1_STRING_TABLE_insert)
#define sk_ASN1_STRING_TABLE_delete BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sk_ASN1_STRING_TABLE_delete)
#define sk_ASN1_STRING_TABLE_delete_ptr BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sk_ASN1_STRING_TABLE_delete_ptr)
#define sk_ASN1_STRING_TABLE_find BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sk_ASN1_STRING_TABLE_find)
#define sk_ASN1_STRING_TABLE_shift BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sk_ASN1_STRING_TABLE_shift)
#define sk_ASN1_STRING_TABLE_push BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sk_ASN1_STRING_TABLE_push)
#define sk_ASN1_STRING_TABLE_pop BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sk_ASN1_STRING_TABLE_pop)
#define sk_ASN1_STRING_TABLE_dup BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sk_ASN1_STRING_TABLE_dup)
#define sk_ASN1_STRING_TABLE_sort BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sk_ASN1_STRING_TABLE_sort)
#define sk_ASN1_STRING_TABLE_is_sorted BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sk_ASN1_STRING_TABLE_is_sorted)
#define sk_ASN1_STRING_TABLE_set_cmp_func BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sk_ASN1_STRING_TABLE_set_cmp_func)
#define sk_ASN1_STRING_TABLE_deep_copy BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sk_ASN1_STRING_TABLE_deep_copy)
#define sk_PMBTOKEN_PRETOKEN_call_free_func BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sk_PMBTOKEN_PRETOKEN_call_free_func)
#define sk_PMBTOKEN_PRETOKEN_call_copy_func BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sk_PMBTOKEN_PRETOKEN_call_copy_func)
#define sk_PMBTOKEN_PRETOKEN_call_cmp_func BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sk_PMBTOKEN_PRETOKEN_call_cmp_func)
#define sk_PMBTOKEN_PRETOKEN_new BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sk_PMBTOKEN_PRETOKEN_new)
#define sk_PMBTOKEN_PRETOKEN_new_null BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sk_PMBTOKEN_PRETOKEN_new_null)
#define sk_PMBTOKEN_PRETOKEN_num BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sk_PMBTOKEN_PRETOKEN_num)
#define sk_PMBTOKEN_PRETOKEN_zero BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sk_PMBTOKEN_PRETOKEN_zero)
#define sk_PMBTOKEN_PRETOKEN_value BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sk_PMBTOKEN_PRETOKEN_value)
#define sk_PMBTOKEN_PRETOKEN_set BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sk_PMBTOKEN_PRETOKEN_set)
#define sk_PMBTOKEN_PRETOKEN_free BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sk_PMBTOKEN_PRETOKEN_free)
#define sk_PMBTOKEN_PRETOKEN_pop_free BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sk_PMBTOKEN_PRETOKEN_pop_free)
#define sk_PMBTOKEN_PRETOKEN_insert BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sk_PMBTOKEN_PRETOKEN_insert)
#define sk_PMBTOKEN_PRETOKEN_delete BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sk_PMBTOKEN_PRETOKEN_delete)
#define sk_PMBTOKEN_PRETOKEN_delete_ptr BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sk_PMBTOKEN_PRETOKEN_delete_ptr)
#define sk_PMBTOKEN_PRETOKEN_find BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sk_PMBTOKEN_PRETOKEN_find)
#define sk_PMBTOKEN_PRETOKEN_shift BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sk_PMBTOKEN_PRETOKEN_shift)
#define sk_PMBTOKEN_PRETOKEN_push BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sk_PMBTOKEN_PRETOKEN_push)
#define sk_PMBTOKEN_PRETOKEN_pop BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sk_PMBTOKEN_PRETOKEN_pop)
#define sk_PMBTOKEN_PRETOKEN_dup BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sk_PMBTOKEN_PRETOKEN_dup)
#define sk_PMBTOKEN_PRETOKEN_sort BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sk_PMBTOKEN_PRETOKEN_sort)
#define sk_PMBTOKEN_PRETOKEN_is_sorted BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sk_PMBTOKEN_PRETOKEN_is_sorted)
#define sk_PMBTOKEN_PRETOKEN_set_cmp_func BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sk_PMBTOKEN_PRETOKEN_set_cmp_func)
#define sk_PMBTOKEN_PRETOKEN_deep_copy BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sk_PMBTOKEN_PRETOKEN_deep_copy)
...
#define sk_SXNETID_call_free_func BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sk_SXNETID_call_free_func)
#define sk_SXNETID_call_copy_func BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sk_SXNETID_call_copy_func)
#define sk_SXNETID_call_cmp_func BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sk_SXNETID_call_cmp_func)
#define sk_SXNETID_new BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sk_SXNETID_new)
#define sk_SXNETID_new_null BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sk_SXNETID_new_null)
#define sk_SXNETID_num BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sk_SXNETID_num)
#define sk_SXNETID_zero BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sk_SXNETID_zero)
#define sk_SXNETID_value BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sk_SXNETID_value)
#define sk_SXNETID_set BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sk_SXNETID_set)
#define sk_SXNETID_free BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sk_SXNETID_free)
#define sk_SXNETID_pop_free BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sk_SXNETID_pop_free)
#define sk_SXNETID_insert BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sk_SXNETID_insert)
#define sk_SXNETID_delete BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sk_SXNETID_delete)
#define sk_SXNETID_delete_ptr BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sk_SXNETID_delete_ptr)
#define sk_SXNETID_find BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sk_SXNETID_find)
#define sk_SXNETID_shift BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sk_SXNETID_shift)
#define sk_SXNETID_push BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sk_SXNETID_push)
#define sk_SXNETID_pop BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sk_SXNETID_pop)
#define sk_SXNETID_dup BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sk_SXNETID_dup)
#define sk_SXNETID_sort BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sk_SXNETID_sort)
#define sk_SXNETID_is_sorted BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sk_SXNETID_is_sorted)
#define sk_SXNETID_set_cmp_func BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sk_SXNETID_set_cmp_func)
#define sk_SXNETID_deep_copy BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sk_SXNETID_deep_copy)
